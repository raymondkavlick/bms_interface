...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(1615, 933)
        Dialog.setStyleSheet(_fromUtf8(""))
        self.buttonBox = QtGui.QDialogButtonBox(Dialog)
        self.buttonBox.setGeometry(QtCore.QRect(1260, 890, 341, 32))
        self.buttonBox.setOrientation(QtCore.Qt.Horizontal)
        self.buttonBox.setStandardButtons(QtGui.QDialogButtonBox.Cancel|QtGui.QDialogButtonBox.Ok)
        self.buttonBox.setObjectName(_fromUtf8("buttonBox"))
        self.pushButton = QtGui.QPushButton(Dialog)
        self.pushButton.setGeometry(QtCore.QRect(910, 840, 151, 61))
        self.pushButton.setObjectName(_fromUtf8("pushButton"))
        self.m_Status = QtGui.QTextEdit(Dialog)
        self.m_Status.setGeometry(QtCore.QRect(1090, 840, 271, 61))
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(41, 131, 432, 551))
        font = QtGui.QFont()
        font.setPointSize(36)
        ...
        self.label.setGeometry(QtCore.QRect(530, 40, 581, 71))
        font = QtGui.QFont()
        font.setPointSize(36)
        font.setBold(True)
        font.setItalic(True)
        ...
        self.label_3.setGeometry(QtCore.QRect(10, 870, 151, 51))
        font = QtGui.QFont()
        ...
        self.textEdit_6.setGeometry(QtCore.QRect(170, 880, 111, 41))
        font = QtGui.QFont()
        ...
        self.textEdit_8.setGeometry(QtCore.QRect(1200, 358, 359, 103))
        font = QtGui.QFont()
        font.setPointSize(36)
        font.setBold(True)
        font.setItalic(True)
        ...
        self.textEdit_9.setGeometry(QtCore.QRect(1200, 467, 359, 103))
        font = QtGui.QFont()
        font.setPointSize(36)
        font.setBold(True)
        font.setItalic(True)
        ...
        self.textEdit_10.setGeometry(QtCore.QRect(1200, 249, 359, 103))
        font = QtGui.QFont()
        font.setPointSize(36)
        font.setBold(True)
        font.setItalic(True)
        ...
        self.textEdit_11.setGeometry(QtCore.QRect(1200, 576, 359, 103))
        font = QtGui.QFont()
        font.setPointSize(36)
        font.setBold(True)
        font.setItalic(True)
        ...
        self.textEdit_12.setGeometry(QtCore.QRect(1200, 140, 359, 103))
        ...
        self.label_11.setGeometry(QtCore.QRect(830, 462, 430, 105))
        font = QtGui.QFont()
        font.setPointSize(36)
        font.setBold(True)
        font.setItalic(True)
        ...
        self.label_12.setGeometry(QtCore.QRect(830, 240, 430, 105))
        font = QtGui.QFont()
        font.setPointSize(36)
        font.setBold(True)
        font.setItalic(True)
        ...
        self.label_13.setGeometry(QtCore.QRect(830, 351, 430, 105))
        font = QtGui.QFont()
        font.setPointSize(36)
        font.setBold(True)
        font.setItalic(True)
        ...
        self.label_14.setGeometry(QtCore.QRect(830, 573, 430, 105))
        font = QtGui.QFont()
        font.setPointSize(36)
        font.setBold(True)
        font.setItalic(True)
        ...
        self.label_15.setGeometry(QtCore.QRect(830, 129, 430, 105))
        font = QtGui.QFont()
        font.setPointSize(36)
        font.setBold(True)
        font.setItalic(True)
        ...
        self.label_2.setGeometry(QtCore.QRect(1250, 20, 111, 31))
        self.label_2.setObjectName(_fromUtf8("label_2"))
        self.pushButton_2 = QtGui.QPushButton(Dialog)
        self.pushButton_2.setGeometry(QtCore.QRect(730, 840, 151, 61))
        self.pushButton_2.setObjectName(_fromUtf8("pushButton_2"))
        self.label_4 = QtGui.QLabel(Dialog)
        self.label_4.setGeometry(QtCore.QRect(1200, 810, 61, 21))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.pushButton_2.setText(_translate("Dialog", "Power Down", None))
