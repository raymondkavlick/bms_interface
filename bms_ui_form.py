...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.connectButton.setGeometry(QtCore.QRect(770, 840, 301, 121))
        font = QtGui.QFont()
        font.setPointSize(22)
        self.connectButton.setFont(font)
        self.connectButton.setObjectName(_fromUtf8("connectButton"))
        self.m_Status = QtGui.QTextEdit(Dialog)
        self.m_Status.setGeometry(QtCore.QRect(1100, 840, 691, 121))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.m_Status.setFont(font)
        ...
        self.powerDownButton.setGeometry(QtCore.QRect(420, 840, 321, 121))
        font = QtGui.QFont()
        font.setPointSize(22)
        self.powerDownButton.setFont(font)
        self.powerDownButton.setObjectName(_fromUtf8("powerDownButton"))
        self.label_4 = QtGui.QLabel(Dialog)
        self.label_4.setGeometry(QtCore.QRect(1400, 790, 141, 41))
        font = QtGui.QFont()
        ...
        self.groupBox.setGeometry(QtCore.QRect(40, 20, 401, 121))
        self.groupBox.setAutoFillBackground(True)
        self.groupBox.setFlat(False)
        self.groupBox.setCheckable(False)
        self.groupBox.setObjectName(_fromUtf8("groupBox"))
        self.label_16 = QtGui.QLabel(self.groupBox)
        self.label_16.setGeometry(QtCore.QRect(10, 40, 161, 31))
        ...
        self.label_18.setGeometry(QtCore.QRect(170, 40, 211, 31))
        self.label_18.setObjectName(_fromUtf8("label_18"))
        self.label_19 = QtGui.QLabel(self.groupBox)
        self.label_19.setGeometry(QtCore.QRect(170, 70, 201, 31))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_2.setText(_translate("Dialog", "Version 1.3.0", None))
        ...
        self.label_18.setText(_translate("Dialog", "Current Limit 260A for 15 sec", None))
        self.label_19.setText(_translate("Dialog", "Current Limit 330A for 6 sec", None))
