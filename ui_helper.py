...
class Ui_Dialog_Derived(bms_ui_form.Ui_Dialog):
    ...
    def catchAll(self,action):
        if action == "buttonDisable":
            ...
            self.label_9.setTextBackgroundColor(QtGui.QColor(0,255,0))
        elif action == "discharge":
            self.label_9.setTextBackgroundColor(QtGui.QColor(255,0,0))
        elif action == "idlecurrent":
            self.label_9.setTextBackgroundColor(QtGui.QColor(255,255,255))
